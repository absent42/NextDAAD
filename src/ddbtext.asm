...
; Pre-anchor ballast (engine.asm's flags ALIGN note): objname.asm's code
; moved in 2026-09 with the sav_write/sav_read deletion. Same labels, no
; paging; objname.asm stays its post-anchor home if the pad is needed.
