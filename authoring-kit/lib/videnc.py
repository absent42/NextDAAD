#!/usr/bin/env python3
"""
lib/videnc.py - open-source encoder for MakeVid/playvid .VID format
(all six playback formats: 0-5). Authoring kit copy of the NextDAAD
...
Requires: Python 3, Pillow (`pip install Pillow` - for ADAPTIVE 256-
colour quantization and the transpose-based column-major reorder).
Everything else is standard library. An ffmpeg binary is required at
run time (default: this kit's own tools\\ffmpeg\\bin\\ffmpeg.exe -
NOT one of this kit's required tools, see tools\\README.txt - install
it there or pass --ffmpeg PATH).
