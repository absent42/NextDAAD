...
| `toolkit/` | Decimal printing, 16-bit flag-pair arithmetic and time formatting. No hook and no arming call - every function runs to completion inside the EXTERN that calls it | 70 print flag as decimal, 71 print pair as decimal, 72-75 16-bit arithmetic, 82 HH:MM, 83 MM:SS | 248 width, 249 operand, 251 result |
