...
| `fade/` | Fades the Layer 2 picture to any RRRGGGBB colour and back - fade to black for a scene change, fade up again. Transparent regions stay transparent; a completed fade-in restores the palette bit for bit | 40 fade out, 41 fade in | 240 done, 241 speed |
